...
NEVER_INLINE void signed_div(STYPE a, STYPE b)
{
...
NEVER_INLINE void unsigned_div(UTYPE a, UTYPE b)
{
...
NEVER_INLINE void test(STYPE a, STYPE b)
{
      signed_div(   a,     b );
...
NEVER_INLINE void signed_div_const(STYPE a)
{
...
NEVER_INLINE void unsigned_div_const(UTYPE a)
{
...
NEVER_INLINE void test_const(STYPE a)
{
      signed_div_const(   a );
