/*
-- File : trv32p5_chess.h
--
-- Contents : Chess header file for the trv32p5 processor.
--
...
#ifndef INCLUDED_TRV32P5_CHESS_H_
#define INCLUDED_TRV32P5_CHESS_H_
...
namespace trv32p5_primitive {
  struct dint property(keep_in_registers llvm_emulated dont_generate) {
    unsigned low;   // trv32p5 is little endian hence MSBs last
    unsigned high;
...
chess_properties {
  ...
  link_register          : LR;
  breakpoint_focus_stage : WB;       // only for ISS, not debug client
  ...
  argument_registers
    w08, w16, w32, unsigned short, unsigned char :
    x10, x11, x12, x13, x14, x15, x16, x17;
}

#include "trv32p5_c_userext-types.h"
#include "trv32p5_c_int.h"
#include "trv32p5_c_longlong.h"
#include "trv32p5_c_setcmp.h"
#include "trv32p5_c_const.h"
#include "trv32p5_c_memfn.h"
#include "trv32p5_c_bitfield.h"
#include "trv32p5_c_float.h"
#include "trv32p5_c_double.h"
#include "trv32p5_c_divbyct.h"
#include "trv32p5_c_userext.h"
#include "trv32p5_c_rewrite.h"

#endif // INCLUDED_TRV32P5_CHESS_H_
