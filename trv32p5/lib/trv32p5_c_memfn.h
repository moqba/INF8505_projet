...
#ifndef INCLUDED_TRV32P5_C_MEMFN_H_
#define INCLUDED_TRV32P5_C_MEMFN_H_

#ifndef TRV32P5_CHESSMEM_THRESHOLD
#define TRV32P5_CHESSMEM_THRESHOLD 5
#endif
    ...
    const unsigned int sz) property(dont_generate)
{
  char* ll = (char*)l;
  char* rr = (char*)r;
  if (chess_manifest(sz < (TRV32P5_CHESSMEM_THRESHOLD))) {
...
#endif /* INCLUDED_TRV32P5_C_MEMFN_H_ */
