...
proc createPlatform { xml } {
  ...
  ::pct::add_initiator i_trv32p5/p_DMb_ft
  ...
  ::pct::set_param_value $HW/i_trv32p5/p_DMb_ft:protocol {Protocol Common Parameters} ft_protocol_tag AXI

  ::pct::create_connection C_DM i_trv32p5/p_DMb_ft i_DMb/MEM
  ...
  ::pct::set_address i_trv32p5/p_DMb_ft:i_DMb/MEM 0x0
