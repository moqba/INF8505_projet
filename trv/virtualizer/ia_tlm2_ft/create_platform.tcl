...
proc createPlatform { xml } {
  ...
  ::pct::add_initiator i_trv32p3/p_PMb_ft
  ::pct::add_initiator i_trv32p3/p_DMb_ft
  ...
  ::pct::set_param_value i_PMb/MEM:protocol {Protocol Common Parameters} ft_protocol_tag AXI
  ::pct::set_param_value i_PMb {Template Arguments} BUSWIDTH 8
  ...
  ::pct::set_param_value i_DMb/MEM:protocol {Protocol Common Parameters} ft_protocol_tag AXI
  ...
  ::pct::set_param_value /HARDWARE/i_trv32p3/p_DMb_ft:protocol {Protocol Common Parameters} ft_protocol_tag AXI
  ::pct::set_param_value /HARDWARE/i_trv32p3/p_PMb_ft:protocol {Protocol Common Parameters} ft_protocol_tag AXI

  ::pct::create_connection C_PM i_trv32p3/p_PMb_ft i_PMb/MEM
  ::pct::global_connect i_ClockGenerator/CLK i_PMb/CLK
  ::pct::create_connection C_DM i_trv32p3/p_DMb_ft i_DMb/MEM
  ...
  ::pct::set_address i_trv32p3/p_PMb_ft:i_PMb/MEM 0x0
  ::pct::set_address i_trv32p3/p_DMb_ft:i_DMb/MEM 0x0
