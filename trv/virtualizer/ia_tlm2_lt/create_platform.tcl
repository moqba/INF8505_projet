...
proc createPlatform { xml } {
  ...
  ::pct::add_initiator i_trv32p3/p_PMb
  ::pct::add_initiator i_trv32p3/p_DMb
  ...
  ::pct::create_connection C_PM i_trv32p3/p_PMb i_PMb/MEM
  ::pct::global_connect i_ClockGenerator/CLK i_PMb/CLK
  ::pct::create_connection C_DM i_trv32p3/p_DMb i_DMb/MEM
  ...
  ::pct::set_address i_trv32p3/p_PMb:i_PMb/MEM 0x0
  ::pct::set_address i_trv32p3/p_DMb:i_DMb/MEM 0x0
