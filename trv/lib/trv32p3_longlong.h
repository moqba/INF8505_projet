...
namespace trv32p3_primitive {
  ...
  promotion unsigned int add(unsigned int,unsigned int) property(duplicate_at_using_opn2) = w32 add(w32,w32);
  promotion unsigned int sub(unsigned int,unsigned int) property(duplicate_at_using_opn2) = w32 sub(w32,w32);
...
namespace trv32p3_primitive {
  ...
  promotion unsigned int mulhu (unsigned int,unsigned int) = w32 mulhu (w32,w32);
  promotion unsigned int mul   (unsigned int,unsigned int) = w32 mul   (w32,w32);
...
namespace trv32p3_primitive {
  ...
  inline bool l_eq(dint a, dint b) property(dont_generate) { return a.high == b.high && a.low == b.low; }

  inline bool l_ne(dint a, dint b) property(dont_generate) { return a.high != b.high || a.low != b.low; }
...
extern "C++"  signed long long  div_called (signed long long, signed long long, chess_output signed long long&) property(functional);

extern "C++"  unsigned long long  div_called (unsigned long long, unsigned long long, chess_output unsigned long long&) property(functional);

// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// ~~~ signed divide and modulo

// additional indirection - to enable common subexpression identification
inline  signed long long  div_called_ (signed long long a, signed long long b, signed long long& r) property(functional) {
...
// additional indirection - to enable common subexpression identification
inline  unsigned long long  div_called_ (unsigned long long a, unsigned long long b, unsigned long long& r) property(functional) {
  return div_called(a,b,r);
}
