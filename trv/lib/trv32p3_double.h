...
// operations
inline     float64_t           wrap_f64_add      (float64_t a, float64_t b) { return f64_add(a,b); }
inline     float64_t           wrap_f64_sub      (float64_t a, float64_t b) { return f64_sub(a,b); }
inline     float64_t           wrap_f64_mul      (float64_t a, float64_t b) { return f64_mul(a,b); }
inline     float64_t           wrap_f64_div      (float64_t a, float64_t b) { return f64_div(a,b); }

// comparisons
inline     bool                wrap_f64_lt       (float64_t a, float64_t b) { return f64_lt(a,b); }
inline     bool                wrap_f64_le       (float64_t a, float64_t b) { return f64_le(a,b); }
inline     bool                wrap_f64_eq       (float64_t a, float64_t b) { return f64_eq(a,b); }

// double<>float conversions
inline     float64_t           wrap_f32_to_f64   (float32_t a)              { return f32_to_f64(a); }
inline     float32_t           wrap_f64_to_f32   (float64_t a)              { return f64_to_f32(a); }

// double<>int conversions
inline       signed int        wrap_f64_to_i32   (float64_t a)              { return f64_to_i32_r_minMag(a, false); }
inline     unsigned int        wrap_f64_to_ui32  (float64_t a)              { return f64_to_ui32_r_minMag(a, false); }
inline     float64_t           wrap_i32_to_f64   (signed int a)             { return i32_to_f64(a); }
inline     float64_t           wrap_ui32_to_f64  (unsigned int a)           { return ui32_to_f64(a); }

// double<>longlong conversions
inline       signed long long  wrap_f64_to_i64   (float64_t a)              { return f64_to_i64_r_minMag(a, false); }
inline     unsigned long long  wrap_f64_to_ui64  (float64_t a)              { return f64_to_ui64_r_minMag(a, false); }
inline     float64_t           wrap_i64_to_f64   (signed long long a)       { return i64_to_f64(a); }
inline     float64_t           wrap_ui64_to_f64  (unsigned long long a)     { return ui64_to_f64(a); }
