/*
-- File : vlx_pdc_interface.c
--
-- Contents : Specialisation of Checkers_pdc_interface for VLX
--
...
#include "vlx_pdc_interface.h"

bool vlx_pdc_interface::expand_into_root_locations(const Checkers_storinfo* s)
{
    return true;  // always expand
}

pdc_commands::instr_type vlx_pdc_interface::get_instruction_at(AddressType pc)
{
...
void vlx_pdc_interface::put_instruction_at(AddressType pc,
...
AddressType vlx_pdc_interface::next_instruction(AddressType pc) { return pc+4; }
AddressType vlx_pdc_interface::prev_instruction(AddressType pc) { return pc-4; }
