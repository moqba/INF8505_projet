/*
-- File : vlx_pdc_interface.h
--
-- Contents : Specialisation of Checkers_pdc_interface for VLX procesor
--
...
#ifndef _vlx_pdc_interface_h
#define _vlx_pdc_interface_h

#include "vlx_define.h"
#include "checkers_pdc_interface.h"

class vlx_pdc_interface : public Checkers_pdc_interface {
public:
 vlx_pdc_interface(int coreid, string server, int port=41001)
