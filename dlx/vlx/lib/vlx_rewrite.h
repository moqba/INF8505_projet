...
-- File : vlx_rewrite.h
--
-- Contents : Chess rewrite rules for the VLX processor.
--
...
#ifndef _vlx_rewrite_h
#define _vlx_rewrite_h
...
// On vlx, the 8 and 16 bit versions are special in that they can be either standalone or part of a memory path.
