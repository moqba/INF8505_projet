...
-- File : vlx.h
--
-- Contents : Processor header-file for the VLX processor.
--
...
// declaration of primitive data types
    ...
    class v4w32    property(vector w32[4]);
    ...
    class int9s16 property( 9 bit   signed, step = 16);
...
//vector primitives
    ...
    v4w32 vadd(v4w32,v4w32,v4u1&)               property(commutative);
    v4w32 vsub(v4w32,v4w32,v4u1&);
    v4w32 vaddx(v4w32,v4w32,v4u1,v4u1&)         property(commutative);
    v4w32 vsubx(v4w32,v4w32,v4u1,v4u1&);

    v4w32 vband(v4w32,v4w32)                    property(commutative);
    v4w32 vbor (v4w32,v4w32)                    property(commutative);
    v4w32 vbxor(v4w32,v4w32)                    property(commutative);
    //v4w32 vxtd (v4w32,v4w32);

    w32 vsge (v4w32,v4w32);
    w32 vsgt (v4w32,v4w32);
    w32 vsle (v4w32,v4w32);
    w32 vslt (v4w32,v4w32);
    v4w32 vselect(w32,v4w32,v4w32);

    w32 vsgeu(v4w32,v4w32);
    w32 vsgtu(v4w32,v4w32);
    w32 vsleu(v4w32,v4w32);
    w32 vsltu(v4w32,v4w32);

    w32 vseq (v4w32,v4w32)  property(commutative);
    w32 vsne (v4w32,v4w32)  property(commutative);

    v4w32 vinsert(v4w32,w32,w32);
    w32 vextract(v4w32,w32);
