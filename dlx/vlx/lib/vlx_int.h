...
-- File : vlx_int.h
--
-- Contents : Integer application layer for the VLX processor.
--
...
promotion operator  unsigned(int)             = nil;
    ...
    promotion operator vlx_primitive::w32(int) = nil;
...
namespace vlx_primitive { // i.c.o. copy_jump (complement) being rewritten again
...
// in situ sign extension

promotion int sign_extend(int,int) = w32 xtd(w32,w32);
