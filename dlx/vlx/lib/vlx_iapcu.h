...
// All rights reserved.
// checkers -B -M -cvlx_ia.ccf vlx

// Processor: vlx

#ifndef __Mdl_vlx_iapcu_user_c__
#define __Mdl_vlx_iapcu_user_c__
...
inline void vlx_user_next_pc(vlx* mdl, unsigned next_pc, unsigned nw, Checkers_next_pc_type npt)
{
    /* User code here */
    mdl->PC = next_pc;
}

inline unsigned vlx_loop_end(vlx* mdl, unsigned nw)
{
