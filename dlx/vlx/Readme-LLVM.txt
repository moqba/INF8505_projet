...
==============================================================================
Notes for the use of the LLVM C front end in VLX.
...
- The LLVM front requires that the compiler-rt library is compiled onto
  the VLX core.  The source code of compiler-rt is processor independent and 
  is not part of the VLX archive.  It is shipped as a separate archive,
  libs-J-2015.03.zip.  This archive must be unpacked as a sibling directory of
  the VLX directory, as follows:
...
- Note that vlx/lib also has a compiler-rt directory, containing only he
  ...
  project file.  Note that this build step is part of the vlx/model.prx file. 
