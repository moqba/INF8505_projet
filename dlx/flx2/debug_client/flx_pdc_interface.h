/*
-- File : flx_pdc_interface.h
--
-- Contents : Specialisation of Checkers_pdc_interface for FLX procesor
--
...
#ifndef _flx_pdc_interface_h
#define _flx_pdc_interface_h

#include "flx_define.h"
#include "checkers_pdc_interface.h"

class flx_pdc_interface : public Checkers_pdc_interface {
public:
 flx_pdc_interface(int coreid, string server, int port=41001)
