...
architecture rtl of fas is
  ...
  signal   fasA      : std_logic_vector(31 downto 0);
  signal   fasB      : std_logic_vector(31 downto 0);
  signal   fasC      : std_logic_vector(31 downto 0);
  ...
  signal   fasC_DLY1 : std_logic_vector(31 downto 0);
...
begin
  ...
  begin
    ...
    if ohe_selector_EX = '0' then
      ...
      fasA <= std_logic_vector(fasA_in);
      fasB <= std_logic_vector(fasB_in);
