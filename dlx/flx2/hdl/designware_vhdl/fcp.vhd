...
architecture rtl of fcp is
  ...
  signal   fcpA  : std_logic_vector(31 downto 0);
  signal   fcpB  : std_logic_vector(31 downto 0);
  ...
  signal   fcpZ0 : std_logic_vector(31 downto 0);
  signal   fcpZ1 : std_logic_vector(31 downto 0);
...
begin
  ...
  begin
    ...
    if bin_selector_EX = "00" then
      ...
      fcpA <= std_logic_vector(fcpA_in);
      fcpB <= std_logic_vector(fcpB_in);
    end if;
