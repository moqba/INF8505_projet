/*
-- File : mcld_pdc_interface.h
--
-- Contents : Specialisation of Checkers_pdc_interface for MCLD procesor
--
...
#ifndef _mcld_pdc_interface_h
#define _mcld_pdc_interface_h

#include "mcld_define.h"
#include "checkers_pdc_interface.h"

class mcld_pdc_interface : public Checkers_pdc_interface {
public:
 mcld_pdc_interface(int coreid, string server, int port=41001)
