/*
-- File : mcld_pdc_interface.c
--
-- Contents : Specialisation of Checkers_pdc_interface for MCLD
--
...
#include "mcld_pdc_interface.h"

bool mcld_pdc_interface::expand_into_root_locations(const Checkers_storinfo* s)
{
    return true;  // always expand
}

pdc_commands::instr_type mcld_pdc_interface::get_instruction_at(AddressType pc)
{
...
void mcld_pdc_interface::put_instruction_at(AddressType pc,
...
AddressType mcld_pdc_interface::next_instruction(AddressType pc) { return pc+4; }
AddressType mcld_pdc_interface::prev_instruction(AddressType pc) { return pc-4; }
