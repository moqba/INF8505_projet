...
-- File : mcld_rewrite.h
--
-- Contents : Chess rewrite rules for the MCLD processor.
--
...
#ifndef _mcld_rewrite_h
#define _mcld_rewrite_h
...
// On mcld, the 8 and 16 bit versions are special in that they can be either standalone or part of a memory path.
