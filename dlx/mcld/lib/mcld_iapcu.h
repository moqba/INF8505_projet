...
// All rights reserved.
// checkers -B -M -cmcld_ia.ccf mcld

// Processor: mcld

#ifndef __Mdl_mcld_iapcu_user_c__
#define __Mdl_mcld_iapcu_user_c__
...
inline void mcld_user_next_pc(mcld* mdl, unsigned next_pc, unsigned nw, Checkers_next_pc_type npt)
{
    /* User code here */
    mdl->PC = next_pc;
}

inline unsigned mcld_loop_end(mcld* mdl, unsigned nw)
{
