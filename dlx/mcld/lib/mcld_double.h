...
#ifndef _mcld_double_h
#define _mcld_double_h
...
inline float64 f64_neg(float64 a) { a.high ^= 0x80000000; return a; }
...
promotion double operator-(double) = float64 f64_neg(float64);
