/*
-- File : mcld_bitfield.h
--
-- Contents : Software bitfield extraction rules for the MCLD processor.
--
...
#ifndef _mcld_bitfield_h
#define _mcld_bitfield_h
