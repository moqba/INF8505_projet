...
#  2) start client ISS:
#         ../tlx_client -t test_4a_breakpoints.tcl -u <host>:<tile>
...
proc test_stepping_with_bp { iss bp_type step_args } {
    ...
    command $iss "breakpoint mic set 6 $bp_type"
...
proc test_clear_bp { iss bp_type step_args } {
    ...
    command $iss "breakpoint mic set 4 $bp_type"
    command $iss "breakpoint mic set 6 $bp_type"
    command $iss "breakpoint mic clear 4"
    command $iss "step -1 $step_args"
    expect_pc $iss 6
    expect_r $iss  R1  1 dec
    expect_r $iss  R6  6 dec
...
proc test_stepping_consecutive_bp { iss bp_type step_args } {
    ...
    command $iss "breakpoint mic set 2 $bp_type"
    command $iss "breakpoint mic set 4 $bp_type"
    command $iss "breakpoint mic set 6 $bp_type"
