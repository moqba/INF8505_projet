/*
-- File : tlx_pdc_interface.h
--
-- Contents : Specialisation of Checkers_pdc_interface for TLX procesor
--
...
#ifndef _tlx_pdc_interface_h
#define _tlx_pdc_interface_h

#include "tlx_define.h"
#include "checkers_pdc_interface.h"

class tlx_pdc_interface : public Checkers_pdc_interface {
public:
 tlx_pdc_interface(int coreid, string server, int port=41001)
