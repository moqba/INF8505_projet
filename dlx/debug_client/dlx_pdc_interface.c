/*
-- File : dlx_pdc_interface.c
--
-- Contents : Specialisation of Checkers_pdc_interface for DLX
--
...
#include "dlx_pdc_interface.h"

bool dlx_pdc_interface::expand_into_root_locations(const Checkers_storinfo* s)
{
    return true;  // always expand   
}

pdc_commands::instr_type dlx_pdc_interface::get_instruction_at(AddressType pc)
{
...
void dlx_pdc_interface::put_instruction_at(AddressType pc,
...
AddressType dlx_pdc_interface::next_instruction(AddressType pc) { return pc+4; }
AddressType dlx_pdc_interface::prev_instruction(AddressType pc) { return pc-4; }
