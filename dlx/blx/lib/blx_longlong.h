...
-- File : blx_longlong.h
--
-- Contents : Long long integer application layer for the BLX processor.
--
...
#ifndef _blx_longlong_h
#define _blx_longlong_h

// dual int representation of long long

namespace blx_primitive {
    struct dint property(keep_in_registers llvm_emulated) {
        unsigned low;    // BLX is little endian hence LSB's first
        unsigned high;
