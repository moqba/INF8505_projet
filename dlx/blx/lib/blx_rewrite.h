...
-- File : blx_rewrite.h
--
-- Contents : Chess rewrite rules for the BLX processor.
--
...
#ifndef _blx_rewrite_h
#define _blx_rewrite_h
...
// On blx, the 8 and 16 bit versions are special in that they can be either standalone or part of a memory path.
