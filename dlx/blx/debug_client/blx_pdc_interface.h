/*
-- File : blx_pdc_interface.h
--
-- Contents : Specialisation of Checkers_pdc_interface for BLX procesor
--
...
#ifndef _blx_pdc_interface_h
#define _blx_pdc_interface_h

#include "blx_define.h"
#include "checkers_pdc_interface.h"

class blx_pdc_interface : public Checkers_pdc_interface {
public:
 blx_pdc_interface(int coreid, string server, int port=41001)
