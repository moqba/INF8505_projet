				     ...
				     clobbers(R4,R5,R6,R7,R8,R9,R12,R13)
{
	...
	div r6,r7
        jr r9
	nop                 // delay slot
	addi r12, r12, #113 // delay slot stalls on result
...
inline assembly void test_div_jr_ds2(int chess_storage(R6) aa, 
                                     int chess_storage(R7) bb)
				     clobbers(R4,R6,R7,R12,R13,R20)
{
    asm_begin
      .direct_eval >>,&,(,),+
    asm_text
        lhi r20, #(Lc>>16)
        ori r20, r0, #(Lc&0xffff)
	nop
	nop
	div r6,r7
        jr r20
	addi r12, r12, #101 // delay slot stalls on result
	addi r13, r13, #103 // delay slot
...
.chess_report __sint
	...
	beqz r2, #Ld     
	slli r2,r12,#1    // delay slot
	or r4,r0,r2       // delay slot
.chess_report __sint
	nop
Ld:     addi r4,r12,#25
.chess_report __sint
...
LOOP:   div r3,r4         // count % 3
        ...
        bnez r5,#LOOP     //
        slli r6,r13,#2    //   [delay slot]
        add r6,r2,r6      // r6 = &a[i % 3]         [delay slot]  
	or r4,r0,r6
.chess_report __sint
	nop
	nop	
