...
-- File : flx_chess.h
--
-- Contents : Chess specific header-file for the FLX processor.
--
...
class float24_t  property(24 bits, sign_magnitude, 8 exp_bits);
chess_properties {
 ...
 // type promotions
    ...
    promotion      float24_t : strong { w32 } transitory { addr };
