...
-- File : flx_rewrite.h
--
-- Contents : Chess rewrite rules for the FLX processor.
--
...
// On flx, the 8 and 16 bit versions are special in that they can be either standalone or part of a memory path.
