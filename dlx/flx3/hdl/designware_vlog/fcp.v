...
module fcp
  ...
  reg    signed [data_width-1:0] fcpA;
  reg    signed [data_width-1:0] fcpB;
  reg    signed [data_width-1:0] fcpC;
  wire                 spcpLT;
  wire                 fcpGT;
  wire                 fcpEQ;
  wire                 fcpUO;
  wire                 fcpZ = 0;
  wire   signed [data_width-1:0] fcpZ0;
  wire   signed [data_width-1:0] fcpZ1;
  ...
  begin : p_fcp_isolate
    ...
    begin
      fcpA = fcpA_in[data_width-1:0];
      fcpB = fcpB_in[data_width-1:0];
    end
  end
