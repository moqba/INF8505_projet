...
architecture rtl of fml is
  ...
  signal   fmlA      : std_logic_vector(data_width-1 downto 0);
  signal   fmlB      : std_logic_vector(data_width-1 downto 0);
  signal   fmlC      : std_logic_vector(data_width-1 downto 0);
  constant fmlRND    : std_logic_vector( 2 downto 0) := "000"; -- round to nearest (even)
  signal   fmlSTAT   : std_logic_vector( 7 downto 0);  -- unused
  signal   fmlC_DLY1 : std_logic_vector(data_width-1 downto 0);
...
begin
  ...
  begin
    ...
    if ohe_selector_EX = '0' then
      ...
      fmlA <= std_logic_vector(fmlA_in(data_width-1 downto 0));
      fmlB <= std_logic_vector(fmlB_in(data_width-1 downto 0));
    end if;
  ...
  fmlC_out <= signed("00000000" & fmlC_DLY1);
