...
// configuration
#define DLX_HAS_DOLOOP
#define DLX_HAS_ZLOOP
#define DLX_IS_LITTLE_ENDIAN
#define DLX_HAS_IRQ             // 16 irq-pins
#define DLX_R_SZ 32             // 32 regs
//#define USE_CUSTOM_RTL       // use custom RTL for div unit
