...
/*
 ...
 not directly preform their action, but rather add this action to a buffer. The
...
public:
    ...
    virtual int add_dwrite(reg_type, long long) = 0;
    ...
    virtual int add_dwrite_dread(reg_type, long long) = 0;
    ...
    virtual int get_next_data(long long&) = 0;
