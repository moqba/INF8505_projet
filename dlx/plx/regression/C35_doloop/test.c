...
int dlp_do_ss(int x, int start, int stop)
{
...
int dlp_do_us(unsigned x, unsigned start, unsigned stop)
{
...
int dlp_while(int x, int start, int stop)
{
...
int dlp_for(int x, int start, int stop)
{
