...
void test_AND_3()
{
    ...
    chess_report( AND_3(0,0,1) );
    chess_report( AND_3(0,1,0) );
    chess_report( AND_3(0,1,1) );
    chess_report( AND_3(1,0,0) );
    chess_report( AND_3(1,0,1) );
    chess_report( AND_3(1,1,0) );
    chess_report( AND_3(1,1,1) );
}
...
void test_OR_3()
{
    ...
    chess_report( OR_3(0,0,1) );
    chess_report( OR_3(0,1,0) );
    chess_report( OR_3(0,1,1) );
    chess_report( OR_3(1,0,0) );
    chess_report( OR_3(1,0,1) );
    chess_report( OR_3(1,1,0) );
    chess_report( OR_3(1,1,1) );
}
...
void test_AND_OR_3()
{
    ...
    chess_report( AND_OR_3(0,0,1) );
    chess_report( AND_OR_3(0,1,0) );
    chess_report( AND_OR_3(0,1,1) );
    chess_report( AND_OR_3(1,0,0) );
    chess_report( AND_OR_3(1,0,1) );
    chess_report( AND_OR_3(1,1,0) );
    chess_report( AND_OR_3(1,1,1) );
}
...
void test_nested()
{
    ...
    chess_report( nested(0,0,1) );
    chess_report( nested(0,1,0) );
    chess_report( nested(0,1,1) );
    chess_report( nested(1,0,0) );
    chess_report( nested(1,0,1) );
    chess_report( nested(1,1,0) );
    chess_report( nested(1,1,1) );
}
...
inline int foo(int& a) { int tmp = a; a = a + 11; return tmp; }


int bar(int& a) { int tmp = a; a = a + 222; return tmp; }
