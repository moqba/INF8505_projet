...
-- File : ilx.h
--
-- Contents : Processor header-file for the ILX processor.
--
...
// declaration of primitive data types
    ...
    class uint6   property( 6 bit unsigned);
    class state   property( 4 bit unsigned);
    class ctxt    property( 2 bit unsigned);
