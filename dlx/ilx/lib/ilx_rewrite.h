...
-- File : ilx_rewrite.h
--
-- Contents : Chess rewrite rules for the ILX processor.
--
...
#ifndef _ilx_rewrite_h
#define _ilx_rewrite_h
...
// On ilx, the 8 and 16 bit versions are special in that they can be either standalone or part of a memory path.
